...
const ModulesMainUi = ({ serviceId, moduleCategoryId }: ModuleMainUiProps) => {
  ...
  useEffect(() => {
    const fetchModule = async () => {
      try {
        const res = await getAllOrganizationModule({
  ...
  return (
    <div className="min-h-screen w-full">
      {loadingModules ? (
        ...
        <div className="w-full md:mt-56 mt-3 flex justify-center items-center">
        ...
        <div className="min-h-screen w-full md:pl-36 p-2 pt-7">
