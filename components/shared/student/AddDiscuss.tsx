...
const AddDiscuss = ({ setIsFormVisible }: any) => {
  ...
  return (
    <div>
      <Drawer open={drawerOpen} onClose={() => setIsFormVisible(false)}>
        ...
        <DrawerContent className="md:px-28 px-2">
          ...
          <DrawerFooter>
            ...
            <DrawerClose>
              <Button className="w-full" variant="outline" onClick={() => setIsFormVisible(false)}>
                Cancel
              </Button>
            </DrawerClose>
          </DrawerFooter>
