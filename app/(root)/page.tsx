...
import { userAvailableorNot } from "@/lib/database/actions/middelware";
      ...
      <div className="w-full min-h-screen bg-cover bg-mainImage flex  items-center flex-col">
        <div className="md:flex gap-4 flex-col justify-center items-center md:mt-36 mt-6 hidden">
          ...
          <p className="md:mx-96 mx-3 text-center">
            Welcome to 'Edu Clinic'! Where Learning Meets Opportunity. Connect
            with top-notch educators and trainers seamlessly. Discover tailored
            modules across various categories. Our 'Best Match' feature ensures
            you find the perfect fit based on your qualifications and skills.
            Start your educational journey today!
          </p>
        </div>
        <div className="md:hidden flex gap-4 flex-col justify-center items-center md:mt-36 mt-6">
          <h1 className="md:text-4xl text-3xl font-semibold text-zinc-900 mx-3 text-center">
            Unleash the Educational Sector with the platform{" "}
            <span>Educlinic</span>
            <br />
            <span className="text-4xl font-semibold mx-3 text-center text-blue-800">
              and Upskill YourSelf
            </span>
          </h1>
        ...
        <div className="flex gap-2 mt-6 flex-wrap justify-center align-middle m-3">
